...
// Route-level error boundary for Transaction.
// Catches errors thrown during rendering of this route segment and its children.
export default function TransactionsDetailError({
  error,
  reset,
}: {
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center p-8">
      <div className="flex max-w-md flex-col items-center gap-6 text-center">
        ...
        <div>
          <h2 className="text-lg font-semibold text-slate-900">Transaction Error</h2>
